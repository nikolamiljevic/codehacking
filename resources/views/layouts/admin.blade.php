...
<!-- Bootstrap Core CSS -->
    <link rel="stylesheet" type="text/css" href="{‌{ asset('css/libs/style.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{‌{ asset('css/libs/bootstraps.min.css') }}">
...
<script src="{‌{ asset('js/libs/bootstraps.min.js') }}"></script>
